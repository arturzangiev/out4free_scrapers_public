...
class MonarchbarSpider(scrapy.Spider):
    name = "monarchbar"
    allowed_domains = ["monarchbar.com"]
    start_urls = ['https://listings.monarchbar.com/']
    ...
    def individual_page(self, response):
        ...
        venue_id = VenueItem.django_model.objects.get(id=5)
        slug = slugify(title)
