...
class QuecumbarSpider(scrapy.Spider):
    name = "quecumbar"
    allowed_domains = ["quecumbar.co.uk"]
    start_urls = ['https://www.quecumbar.co.uk/listings/']
    ...
    def individual_page(self, response):
        ...
        venue_id = VenueItem.django_model.objects.get(id=10)
        slug = slugify(title)
